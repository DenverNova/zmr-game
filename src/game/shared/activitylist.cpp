...
//HL2MP
	...
	// Item3
	REGISTER_SHARED_ACTIVITY( ACT_MP_STAND_ITEM3 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCH_ITEM3 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RUN_ITEM3 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_WALK_ITEM3 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_AIRWALK_ITEM3 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCHWALK_ITEM3 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_ITEM3 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_START_ITEM3 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_FLOAT_ITEM3 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_LAND_ITEM3 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SWIM_ITEM3 );

	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_ITEM3 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_ITEM3_SECONDARY );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_ITEM3 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_ITEM3_SECONDARY );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_ITEM3 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_AIRWALK_ITEM3 );

	REGISTER_SHARED_ACTIVITY( ACT_MP_DEPLOYED_ITEM3 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_DEPLOYED_IDLE_ITEM3 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCHWALK_DEPLOYED_ITEM3 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCH_DEPLOYED_IDLE_ITEM3 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_PRIMARY_DEPLOYED_ITEM3 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_PRIMARY_DEPLOYED_ITEM3 );

	// Item4
	REGISTER_SHARED_ACTIVITY( ACT_MP_STAND_ITEM4 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCH_ITEM4 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RUN_ITEM4 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_WALK_ITEM4 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_AIRWALK_ITEM4 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCHWALK_ITEM4 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_ITEM4 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_START_ITEM4 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_FLOAT_ITEM4 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_LAND_ITEM4 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SWIM_ITEM4 );

	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_ITEM4 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_ITEM4_SECONDARY );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_ITEM4 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_ITEM4_SECONDARY );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_ITEM4 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_AIRWALK_ITEM4 );

	REGISTER_SHARED_ACTIVITY( ACT_MP_DEPLOYED_ITEM4 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_DEPLOYED_IDLE_ITEM4 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCHWALK_DEPLOYED_ITEM4 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCH_DEPLOYED_IDLE_ITEM4 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_PRIMARY_DEPLOYED_ITEM4 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_PRIMARY_DEPLOYED_ITEM4 );
	...
	REGISTER_SHARED_ACTIVITY( ACT_ITEM4_VM_DRAW );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM4_VM_HOLSTER );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM4_VM_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM4_VM_PULLBACK );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM4_VM_PRIMARYATTACK );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM4_VM_SECONDARYATTACK );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM4_VM_RELOAD );			
	REGISTER_SHARED_ACTIVITY( ACT_ITEM4_VM_DRYFIRE );		
	REGISTER_SHARED_ACTIVITY( ACT_ITEM4_VM_IDLE_TO_LOWERED );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM4_VM_IDLE_LOWERED );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM4_VM_LOWERED_TO_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM4_VM_CHARGE );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM4_VM_IDLE_2 );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM4_VM_IDLE_3 );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM4_VM_CHARGE_IDLE_3 );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM4_VM_HITCENTER );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM4_VM_SWINGHARD );
	...
	REGISTER_SHARED_ACTIVITY( ACT_ITEM3_ATTACK_STAND_PREFIRE );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM3_ATTACK_STAND_POSTFIRE );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM3_ATTACK_STAND_STARTFIRE );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM3_ATTACK_CROUCH_PREFIRE );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM3_ATTACK_CROUCH_POSTFIRE );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM3_ATTACK_SWIM_PREFIRE );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM3_ATTACK_SWIM_POSTFIRE );

	REGISTER_SHARED_ACTIVITY( ACT_ITEM4_ATTACK_STAND_PREFIRE );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM4_ATTACK_STAND_POSTFIRE );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM4_ATTACK_STAND_STARTFIRE );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM4_ATTACK_CROUCH_PREFIRE );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM4_ATTACK_CROUCH_POSTFIRE );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM4_ATTACK_SWIM_PREFIRE );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM4_ATTACK_SWIM_POSTFIRE );
	...
	REGISTER_SHARED_ACTIVITY( ACT_BALL_VM_CATCH );
	REGISTER_SHARED_ACTIVITY( ACT_BALL_VM_PICKUP );
	REGISTER_SHARED_ACTIVITY( ACT_BALL_VM_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_BALL_VM_THROW_START );
	REGISTER_SHARED_ACTIVITY( ACT_BALL_VM_THROW_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_BALL_VM_THROW_END );

	REGISTER_SHARED_ACTIVITY ( ACT_MP_COMPETITIVE_LOSERSTATE );
	REGISTER_SHARED_ACTIVITY ( ACT_MP_COMPETITIVE_WINNERSTATE );

	REGISTER_SHARED_ACTIVITY( ACT_SECONDARY_VM_ALTATTACK );
	REGISTER_SHARED_ACTIVITY( ACT_MP_PUSH_STAND_SECONDARY );
	REGISTER_SHARED_ACTIVITY( ACT_MP_PUSH_CROUCH_SECONDARY );
	REGISTER_SHARED_ACTIVITY( ACT_MP_PUSH_SWIM_SECONDARY );

	REGISTER_SHARED_ACTIVITY( ACT_MELEE_VM_ITEM1_DRAW );

	REGISTER_SHARED_ACTIVITY( ACT_MP_FALLING_STOMP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_FALLING_STOMP_PRIMARY );
	REGISTER_SHARED_ACTIVITY( ACT_MP_FALLING_STOMP_MELEE );

	REGISTER_SHARED_ACTIVITY( ACT_ITEM_DEPLOY );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM_UNDEPLOY );

	REGISTER_SHARED_ACTIVITY( ACT_MELEE_ALLCLASS_VM_INSPECT_START );
	REGISTER_SHARED_ACTIVITY( ACT_MELEE_ALLCLASS_VM_INSPECT_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_MELEE_ALLCLASS_VM_INSPECT_END );
	
	REGISTER_SHARED_ACTIVITY( ACT_SPECIAL_VM_INSPECT_START );
	REGISTER_SHARED_ACTIVITY( ACT_SPECIAL_VM_INSPECT_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_SPECIAL_VM_INSPECT_END );
	
	REGISTER_SHARED_ACTIVITY( ACT_ITEM1_VM_INSPECT_START );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM1_VM_INSPECT_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM1_VM_INSPECT_END );
	
	REGISTER_SHARED_ACTIVITY( ACT_ITEM2_VM_INSPECT_START );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM2_VM_INSPECT_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM2_VM_INSPECT_END );

	REGISTER_SHARED_ACTIVITY( ACT_ITEM3_VM_INSPECT_START );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM3_VM_INSPECT_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM3_VM_INSPECT_END );

	REGISTER_SHARED_ACTIVITY( ACT_ITEM4_VM_INSPECT_START );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM4_VM_INSPECT_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_ITEM4_VM_INSPECT_END );
	
	REGISTER_SHARED_ACTIVITY( ACT_PRIMARY_ALT1_VM_INSPECT_START );
	REGISTER_SHARED_ACTIVITY( ACT_PRIMARY_ALT1_VM_INSPECT_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_PRIMARY_ALT1_VM_INSPECT_END );

	REGISTER_SHARED_ACTIVITY( ACT_SECONDARY_ALT1_VM_INSPECT_START );
	REGISTER_SHARED_ACTIVITY( ACT_SECONDARY_ALT1_VM_INSPECT_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_SECONDARY_ALT1_VM_INSPECT_END );
	
	REGISTER_SHARED_ACTIVITY( ACT_MELEE_ALT1_VM_INSPECT_START );
	REGISTER_SHARED_ACTIVITY( ACT_MELEE_ALT1_VM_INSPECT_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_MELEE_ALT1_VM_INSPECT_END );

	REGISTER_SHARED_ACTIVITY( ACT_MELEE_ALT2_VM_INSPECT_START );
	REGISTER_SHARED_ACTIVITY( ACT_MELEE_ALT2_VM_INSPECT_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_MELEE_ALT2_VM_INSPECT_END );

	REGISTER_SHARED_ACTIVITY( ACT_MELEE_ALT3_VM_INSPECT_START );
	REGISTER_SHARED_ACTIVITY( ACT_MELEE_ALT3_VM_INSPECT_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_MELEE_ALT3_VM_INSPECT_END );

	REGISTER_SHARED_ACTIVITY( ACT_BUILDING_VM_INSPECT_START );
	REGISTER_SHARED_ACTIVITY( ACT_BUILDING_VM_INSPECT_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_BUILDING_VM_INSPECT_END );

	REGISTER_SHARED_ACTIVITY( ACT_BREADMONSTER_VM_INSPECT_START );
	REGISTER_SHARED_ACTIVITY( ACT_BREADMONSTER_VM_INSPECT_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_BREADMONSTER_VM_INSPECT_END );

	REGISTER_SHARED_ACTIVITY( ACT_SLAP_VM_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_SLAP_VM_DRAW );
	REGISTER_SHARED_ACTIVITY( ACT_SLAP_VM );
